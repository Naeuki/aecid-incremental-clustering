...
input_file = 'c:\Users\Adapt\aecid-incremental-clustering\aecid-incremental-clustering\data\in\mainlog' # Path to input log file
output_file = 'c:\Users\Adapt\aecid-incremental-clustering\aecid-incremental-clustering\data\out\clusters(test).txt' # Path to output file
